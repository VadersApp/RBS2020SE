...
namespace RBS2020 {
	...
	float MorphProcedural::GetMorphfactorBreasts() { return morphfactorBreasts; }
	...
	float MorphProcedural::GetMorphValueBreasts() {
		return (GetRandomFloatNormalByWeight(0.0, 0.05) + GetRandomFloat(0.0, 0.75)) *
			(morphfactorBreasts / 100);
	}
	float MorphProcedural::GetMorphValueBreastsNewSH() {
		return GetRandomFloatNormalByWeight(0.0, 0.09);
	}
